...
![1613271.png](https://images.gitbook.cn/b12ba340-7808-11ea-b264-6326f7cc0e82)
...
安装 JVisualVM 插件的操作，我们在前面的章节《[JDK 内置图形界面工具](https://gitbook.cn/gitchat/column/5de76cc38d374b7721a15cec/topic/5df0be5d44f0aa237c287862)》中介绍过。
...
![82699966.png](https://images.gitbook.cn/d59e3c10-7808-11ea-8c74-b966eb0a8d67)

然后在插件安装界面中，找到“可用插件”：

![82770532.png](https://images.gitbook.cn/0665b8f0-7809-11ea-8e11-89f2c26dd0be)

勾选“BTrace Workbench”之后，点击“安装(I)”按钮。

> 如果插件不显示，请更新 JDK 到最新版。

![82937996.png](https://images.gitbook.cn/3661cf80-7809-11ea-a98c-83821ebf98cb)

按照引导和提示，继续安装即可。

![82991766.png](https://images.gitbook.cn/4aa27120-7809-11ea-86cb-4dea263d5534)

接受协议，并点击安装。

![83219940.png](https://images.gitbook.cn/53216e00-7809-11ea-b61a-45f5a80e7f1b)

等待安装完成：

![83257210.png](https://images.gitbook.cn/5c553bf0-7809-11ea-8e11-89f2c26dd0be)

点击“完成”按钮即可。

**BTrace 插件使用**

![85267702.png](https://images.gitbook.cn/689845b0-7809-11ea-8856-57a8f16560a7)

打开后默认的界面如下：

![85419826.png](https://images.gitbook.cn/70515a80-7809-11ea-8e11-89f2c26dd0be)
...
![6182718.png](https://images.gitbook.cn/60607910-780b-11ea-8e11-89f2c26dd0be)
...
![8128798.png](https://images.gitbook.cn/94b56270-780b-11ea-a3f1-b7b0a6636d71)

然后我们输入需要连接（Attach）的 JVM 进程，例如 1，然后回车。

![8296362.png](https://images.gitbook.cn/a10febd0-780b-11ea-a3f1-b7b0a6636d71)
...
![8871310.png](https://images.gitbook.cn/ab1588b0-780b-11ea-b760-29671afaaa1a)

环境变量 sysenv：

![9257854.png](https://images.gitbook.cn/b2e1d760-780b-11ea-8856-57a8f16560a7)

查看线程信息，输入命令 thread：

![8831103.png](https://images.gitbook.cn/bae2a390-780b-11ea-b61a-45f5a80e7f1b)
...
![9104344.png](https://images.gitbook.cn/c3a51210-780b-11ea-8e11-89f2c26dd0be)

某些选项可以设置，这里给出了示例 `vmoption PrintGCDetails true`。

查找类 sc：

![9474443.png](https://images.gitbook.cn/7c81e650-780c-11ea-a89b-47a48ccffebe)

反编译代码 jad：

![9593919.png](https://images.gitbook.cn/8ec49510-780c-11ea-8c74-b966eb0a8d67)

堆内存转储 heapdump：

![9834789.png](https://images.gitbook.cn/85d59850-780c-11ea-b760-29671afaaa1a)

跟踪方法执行时间 trace：

![9997095.png](https://images.gitbook.cn/976068c0-780c-11ea-a98c-83821ebf98cb)

观察方法执行 watch：

![10270279.png](https://images.gitbook.cn/9e27a380-780c-11ea-9105-57164a9a27ea)
...
![85731ea7-1c8c-4f9a-8869-bd25f61e3300.png](https://images.gitbook.cn/f4c62b30-780c-11ea-b264-6326f7cc0e82)

完成上面的步骤后，可以得到类似这样的信息：

![f6c5d90d-104f-474e-b9fe-fa4d351871da.png](https://images.gitbook.cn/fcd5eb80-780c-11ea-9105-57164a9a27ea)

上图按照每个类被创建的对象数量多少来排序。看第一行可以知道，创建的最多的对象是 int[] 数组。鼠标右键单击这行，就可以看到这些对象都在哪些地方创建的：

![e9583002-b04a-4a2c-8e94-3c9e0e57557a.png](https://images.gitbook.cn/05cc1430-780d-11ea-8856-57a8f16560a7)

与 hprof 相比，JVisualVM 更加容易使用 —— 比如上面的截图中，在一个地方就可以看到所有 int[] 的分配信息，所以多次在同一处代码进行分配的情况就很容易发现。

#### **AProf**

AProf 是一款重要的分析器，是由 Devexperts 开发的 **[AProf](https://code.devexperts.com/display/AProf/About+Aprof)**。内存分配分析器 AProf 也被打包为 Java agent 的形式。
