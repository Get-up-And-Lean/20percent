目录
1. [createBeanDefinitionDocumentReader](#createBeanDefinitionDocumentReader)
2. [registerBeanDefinitions](#registerBeanDefinitions)
   1. [DefaultBeanDefinitionDocumentReader](#DefaultBeanDefinitionDocumentReader)
     
      2. [parseBeanDefinitions](#parseBeanDefinitions)
3. [createReaderContext](#createReaderContext)
4. [小结](#小结)
...
![时序图](http://static2.iocoder.cn/images/Spring/2019-02-16/01.jpg)
