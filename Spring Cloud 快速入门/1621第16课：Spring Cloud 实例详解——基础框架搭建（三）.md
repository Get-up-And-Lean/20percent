# 16/21第16课：Spring Cloud 实例详解——基础框架搭建（三）
...
![enter image description here](http://images.gitbook.cn/cf2da190-786e-11e8-b30f-e135213f0339)
...
前后端的传输通过 HTTP 进行传输，也带来了一些安全问题，如果抓包、模拟请求、洪水攻击、参数劫持、网络爬虫等。如何对非法请求进行有效拦截，保护合法请求的权益是这篇文章需要讨论的。
...
![img](http://images.gitbook.cn/6f19d910-7911-11e8-b06c-81deae508e47)
